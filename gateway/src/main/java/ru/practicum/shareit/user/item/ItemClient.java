...
public class ItemClient extends BaseClient {
    ...
    public ResponseEntity<Object> searchForItem(String searchCriteria, Integer from, Integer size) {
        Map<String, Object> parameters = Map.of(
                "searchCriteria", searchCriteria,
                "from", from,
                "size", size
        );
        return get("/search?text={searchCriteria}&from={from}&size={size}", parameters);
    }

    public ResponseEntity<Object> createCommentToItem(Long userId, Long itemId, CommentDto commentDto) {
